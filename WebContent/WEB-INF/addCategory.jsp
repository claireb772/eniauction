...
<form class="col-12 col-md-8  d-flex bg-light p-3 flex-column" action="<%=request.getContextPath()%>/addCategory" method="post" >
	...
	<button type="submit" role="button" class="btn btn-primary m-3 w-50">Ajouter</button>
</form>
</main>
</body>
</html>