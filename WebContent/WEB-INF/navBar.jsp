...
<a href="./" class="text-white text-decoration-none">Enchere</a>
    <div class="links justify-self-end">
        <c:if test="${sessionScope.authentification == 1}"  >
            ...
            <a href="./BuyCoins" class="text-decoration-none text-white"><c:out value="${money }" /> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-coin" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M8 13.5a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zm0 .5A6 6 0 1 0 8 2a6 6 0 0 0 0 12z"/>
        ...
        <a id="darkMode" href="?darkMode=<c:out value="${sessionScope.darkMode == 1 ? 0 : 1 }"/>"><button class="text-white bg-primary border-none">
