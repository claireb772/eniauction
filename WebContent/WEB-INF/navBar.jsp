...
<a href="./" class="text-white text-decoration-none">Enchere</a>
	<div class="links justify-self-end">
		<c:if test="${sessionScope.authentification == 1}"  >
			...
			<a class="text-decoration-none text-white"><c:out value="${user.getCredit() }"/> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-coin" viewBox="0 0 16 16">
