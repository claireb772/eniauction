...
public class DisplayRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(b== false) {
			ListeErreur.add("Le mot de passe ne respecte pas les crit�res de s�curit�: doit contenir 1 majuscule,1 minuscule, 1 chiffre ainsi qu'un charact�re sp�cial (*$)");
		}
		if (!Password.equals(Confirmation)) {
			ListeErreur.add("Les mots de passe ne correspondent pas");	// Password doit �tre �gal a Confirmation, et B= respecte les crit�res
